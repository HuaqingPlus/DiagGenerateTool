...
extern QString Str_File_DcmGemeral_Configs;
...
void MainWindow::MainWindow_Init(void)
{
    ...
    Ptr_TableView_OpCycle = new QTableView(this);
    Ptr_TableView_Debounce = new QTableView(this);
    Ptr_TableView_DTC = new QTableView(this);
...
void MainWindow::Slot_ComboBox_Alogclass(int index)
{
}
void MainWindow::Slot_ComboBox_Behavior(int index)
{;
}
void MainWindow::Slot_ComboBox_EventKind(int index)
{
}

void MainWindow::Slot_UpdateDTCInfos_Data(const QModelIndex &topLeft, const QModelIndex &bottomRight)
{
}
