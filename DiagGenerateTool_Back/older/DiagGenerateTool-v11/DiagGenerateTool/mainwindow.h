...
public slots:
    ...
    void Slot_ComboBox_Alogclass(int index);
    void Slot_ComboBox_Behavior(int index);
    void Slot_ComboBox_EventKind(int index);
    void Slot_UpdateDTCInfos_Data(const QModelIndex &topLeft, const QModelIndex &bottomRight);
