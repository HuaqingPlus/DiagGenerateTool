...
#define NVM_NUM_OF_BLOCKS                                           ((uint8)15)
//BlockId
...
#define NvmCfg_BlockConfig_Table \
	...
	{\
		...
		Dem_NvM_JobFinished,          /*   void(*SingleBlockCallback)(void);     */ \
 		...
 		(uint8*)&Dem_Cfg_OpCycle_Default,/*   uint8*    RomBlockDataAddress;        */ \
 		2,                            /*   uint16    NvBlockBaseNumber;          */ \
 		9,                            /*   uint16    NvBlockLength;              */ \
 		0,                            /*   uint16    NvRamBlockIdentifier;       */ \
 		1,                            /*   uint8     BlockJobPriority;           */ \
 		0,                            /*   uint8     MaxNumReadRetries;          */ \
 		0,                            /*   uint8     MaxNumWriteRetries;         */ \
	...
	{\
		...
		Dem_NvM_JobFinished,          /*   void(*SingleBlockCallback)(void);     */ \
 		...
 		(uint8*)&Dem_Cfg_AdminData_Default,/*   uint8*    RomBlockDataAddress;        */ \
	...
	{\
		...
		Dem_NvM_JobFinished,          /*   void(*SingleBlockCallback)(void);     */ \
 		...
 		(uint8*)&Dem_Cfg_StatusData_Default,/*   uint8*    RomBlockDataAddress;        */ \
