 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: CanNm_Cfg.h
 *   Generation Time: 2022-07-21 09:19:36
...
#define CanNmConf_CanNmTxPdu_EIDC_NM_oC03_for_EL_CAN_V2_1_1aed8ca4_Tx 0
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define CanNmConf_CanNmUserDataTxPdu_CanNmUserDataTxPdu               0
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define CanNmConf_CanNmRxPdu_C03_for_EL_CAN_V2_1_CAN_db47340e_Rx      0
/**\} */
...
#define CANNM_USE_DUMMY_STATEMENT STD_ON /* /MICROSAR/vSet/vSetGeneral/vSetDummyStatementKind */
#endif
...
#endif
#ifndef CANNM_PROCESSOR_RH850_1651
#define CANNM_PROCESSOR_RH850_1651
#endif
...
#define CANNM_REPEATMSGINDENABLEDOFCHANNELCONFIG                      STD_ON
#define CANNM_RETRYFIRSTMESSAGEREQUESTOFCHANNELCONFIG                 STD_ON
...
#define CANNM_RETRYFIRSTMESSAGEREQUESTFLAG                            STD_ON
...
#define CANNM_SIZEOFRETRYFIRSTMESSAGEREQUESTFLAG                      STD_ON
...
#define CANNM_RETRYFIRSTMESSAGEREQUESTFLAGOFPCCONFIG                  STD_ON
...
#define CANNM_SIZEOFRETRYFIRSTMESSAGEREQUESTFLAGOFPCCONFIG            STD_ON
...
#define CANNM_ISDEF_REPEATMSGINDENABLEDOFCHANNELCONFIG                STD_OFF
#define CANNM_ISDEF_RETRYFIRSTMESSAGEREQUESTOFCHANNELCONFIG           STD_OFF
...
#define CANNM_ISDEF_RETRYFIRSTMESSAGEREQUESTFLAGOFPCCONFIG            STD_ON
...
#define CANNM_EQ2_REPEATMSGINDENABLEDOFCHANNELCONFIG                  
#define CANNM_EQ2_RETRYFIRSTMESSAGEREQUESTOFCHANNELCONFIG             
...
#define CANNM_EQ2_RETRYFIRSTMESSAGEREQUESTFLAGOFPCCONFIG              CanNm_RetryFirstMessageRequestFlag.raw
...
#define CanNm_GetRetryFirstMessageRequestFlagOfPCConfig()             CanNm_RetryFirstMessageRequestFlag.raw  /**< the pointer to CanNm_RetryFirstMessageRequestFlag */
...
#define CanNm_GetSizeOfRetryFirstMessageRequestFlagOfPCConfig()       CanNm_GetSizeOfChannelConfigOfPCConfig()  /**< the number of accomplishable value elements in CanNm_RetryFirstMessageRequestFlag */
...
#define CanNm_IsRepeatMsgIndEnabledOfChannelConfig(Index)             ((CanNm_GetChannelConfigOfPCConfig()[(Index)].RepeatMsgIndEnabledOfChannelConfig) != FALSE)
#define CanNm_IsRetryFirstMessageRequestOfChannelConfig(Index)        ((CanNm_GetChannelConfigOfPCConfig()[(Index)].RetryFirstMessageRequestOfChannelConfig) != FALSE)
...
#define CanNm_IsRetryFirstMessageRequestFlag(Index)                   ((CanNm_GetRetryFirstMessageRequestFlagOfPCConfig()[(Index)]) != FALSE)
...
#define CanNm_GetSizeOfRetryFirstMessageRequestFlag()                 CanNm_GetSizeOfRetryFirstMessageRequestFlagOfPCConfig()
...
#define CanNm_SetRetryFirstMessageRequestFlag(Index, Value)           CanNm_GetRetryFirstMessageRequestFlagOfPCConfig()[(Index)] = (Value)
...
#define CanNm_HasRepeatMsgIndEnabledOfChannelConfig()                 (TRUE != FALSE)
#define CanNm_HasRetryFirstMessageRequestOfChannelConfig()            (TRUE != FALSE)
...
#define CanNm_HasRetryFirstMessageRequestFlag()                       (TRUE != FALSE)
...
#define CanNm_HasSizeOfRetryFirstMessageRequestFlag()                 (TRUE != FALSE)
...
#define CanNm_HasRetryFirstMessageRequestFlagOfPCConfig()             (TRUE != FALSE)
...
#define CanNm_HasSizeOfRetryFirstMessageRequestFlagOfPCConfig()       (TRUE != FALSE)
...
/**   \brief  type used to iterate CanNm_RetryFirstMessageRequestFlag */
typedef CanNm_ChannelConfigIterType CanNm_RetryFirstMessageRequestFlagIterType;
...
/**   \brief  value based type definition for CanNm_RepeatMsgIndEnabledOfChannelConfig */
typedef boolean CanNm_RepeatMsgIndEnabledOfChannelConfigType;

/**   \brief  value based type definition for CanNm_RetryFirstMessageRequestOfChannelConfig */
typedef boolean CanNm_RetryFirstMessageRequestOfChannelConfigType;
...
/**   \brief  value based type definition for CanNm_RetryFirstMessageRequestFlag */
typedef boolean CanNm_RetryFirstMessageRequestFlagType;
...
/**   \brief  value based type definition for CanNm_SizeOfRetryFirstMessageRequestFlag */
typedef uint8 CanNm_SizeOfRetryFirstMessageRequestFlagType;
...
typedef struct sCanNm_ChannelConfigType
{
  ...
  CanNm_RepeatMsgIndEnabledOfChannelConfigType RepeatMsgIndEnabledOfChannelConfig;  /**< Determines if Repeat Message Indication feature is active or not */
  CanNm_RetryFirstMessageRequestOfChannelConfigType RetryFirstMessageRequestOfChannelConfig;  /**< Determines if Retry First Message Request feature is active or not */
...
{
  CanNm_CommStateType CN_C03_for_EL_CAN_V2_1_776d6b8e;
...
{
  CanNm_CoordReadyToSleepStateType CN_C03_for_EL_CAN_V2_1_776d6b8e;
...
{
  CanNm_MsgConfirmationFlagType CN_C03_for_EL_CAN_V2_1_776d6b8e;
...
{
  CanNm_MsgIndicationFlagType CN_C03_for_EL_CAN_V2_1_776d6b8e;
...
{
  CanNm_MsgRequestType CN_C03_for_EL_CAN_V2_1_776d6b8e;
...
{
  CanNm_MsgTimeoutTimerType CN_C03_for_EL_CAN_V2_1_776d6b8e;
...
{
  CanNm_MsgTimerType CN_C03_for_EL_CAN_V2_1_776d6b8e;
...
{
  CanNm_NetworkRestartFlagType CN_C03_for_EL_CAN_V2_1_776d6b8e;
...
{
  CanNm_NmStateType CN_C03_for_EL_CAN_V2_1_776d6b8e;
...
{
  CanNm_RepeatMsgBitIndFlagType CN_C03_for_EL_CAN_V2_1_776d6b8e;
...
{
  CanNm_RepeatMsgReqFlagType CN_C03_for_EL_CAN_V2_1_776d6b8e;
...
{
  CanNm_RepeatMsgTimerType CN_C03_for_EL_CAN_V2_1_776d6b8e;
} CanNm_RepeatMsgTimerStructSType;

/**   \brief  type to be used as symbolic data element access to CanNm_RetryFirstMessageRequestFlag */
typedef struct CanNm_RetryFirstMessageRequestFlagStructSTag
{
  CanNm_RetryFirstMessageRequestFlagType CN_C03_for_EL_CAN_V2_1_776d6b8e;
} CanNm_RetryFirstMessageRequestFlagStructSType;

/**   \brief  type to be used as symbolic data element access to CanNm_TimeoutTimer */
typedef struct CanNm_TimeoutTimerStructSTag
{
  CanNm_TimeoutTimerType CN_C03_for_EL_CAN_V2_1_776d6b8e;
...
{
  CanNm_TxControlStateType CN_C03_for_EL_CAN_V2_1_776d6b8e;
...
{
  CanNm_TxControlStateRequestType CN_C03_for_EL_CAN_V2_1_776d6b8e;
...
{
  CanNm_WaitBusSleepTimerType CN_C03_for_EL_CAN_V2_1_776d6b8e;
...
/**   \brief  type to access CanNm_RetryFirstMessageRequestFlag in an index and symbol based style. */
typedef union CanNm_RetryFirstMessageRequestFlagUTag
{  /* PRQA S 0750 */  /* MD_CSL_Union */
  CanNm_RetryFirstMessageRequestFlagType raw[1];
  CanNm_RetryFirstMessageRequestFlagStructSType str;
} CanNm_RetryFirstMessageRequestFlagUType;
...
/**   \brief  type used to point to CanNm_RetryFirstMessageRequestFlag */
typedef P2VAR(CanNm_RetryFirstMessageRequestFlagType, TYPEDEF, CANNM_VAR_NOINIT) CanNm_RetryFirstMessageRequestFlagPtrType;
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(CanNm_RetryFirstMessageRequestFlagUType, CANNM_VAR_NOINIT) CanNm_RetryFirstMessageRequestFlag;  /* PRQA S 0777, 0759 */  /* MD_MSR_Rule5.1, MD_CSL_Union */
#define CANNM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
