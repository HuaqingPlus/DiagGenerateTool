...
/**   \brief  type used to iterate CanTp_TxQueue */
typedef uint8_least CanTp_TxQueueIterType;
...
/**   \brief  value based type definition for CanTp_SizeOfTxQueue */
typedef uint8 CanTp_SizeOfTxQueueType;
...
/**   \brief  type used to point to CanTp_TxQueue */
typedef P2VAR(CanTp_TxQueueType, TYPEDEF, CANTP_VAR_NOINIT) CanTp_TxQueuePtrType;
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(CanTp_TxQueueType, CANTP_VAR_NOINIT) CanTp_TxQueue[1];
#define CANTP_STOP_SEC_VAR_NOINIT_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
