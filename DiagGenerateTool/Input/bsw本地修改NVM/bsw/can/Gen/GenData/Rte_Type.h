...
# define Rte_TypeDef_Dcm_VsgIdentifierType
typedef uint8 Dcm_VsgIdentifierType;

# define Rte_TypeDef_Dcm_VsgStateType
typedef uint8 Dcm_VsgStateType;
...
# define Rte_TypeDef_Dcm_VsgIdentifierArrayType
typedef Dcm_VsgIdentifierType Dcm_VsgIdentifierArrayType[1];
