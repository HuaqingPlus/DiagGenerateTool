 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: CanTp_Cfg.h
 *   Generation Time: 2022-07-19 12:25:31
...
#endif
#ifndef CANTP_PROCESSOR_RH850_1651
#define CANTP_PROCESSOR_RH850_1651
#endif
...
#define CANTP_TRANSMIT_QUEUE                                                   STD_ON 
...
/* -----------------------------------------------------------------------------
    &&&~ Rx Sdu Handle IDs
----------------------------------------------------------------------------- */
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_d9548202 0u 
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_5fd7b917 1u 

 
/* -----------------------------------------------------------------------------
    &&&~ Tx Sdu Handle IDs
----------------------------------------------------------------------------- */
#define CanTpConf_CanTpTxNSdu_CanTpTxNSdu_d9548202 0u 


/* -----------------------------------------------------------------------------
    &&&~ Rx Pdu IDs
 ----------------------------------------------------------------------------- */
#define CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_74904915 0u 
#define CanTpConf_CanTpRxNPdu_CanTpRxNPdu_566a9de7     0u 
#define CanTpConf_CanTpRxNPdu_CanTpRxNPdu_cc4262e8     1u 


/* -----------------------------------------------------------------------------
    &&&~ TxConfirmation Pdu IDs
 ----------------------------------------------------------------------------- */
#define CanTpConf_CanTpTxFcNPdu_CanTpTxFcNPdu_566a9de7 0u 
#define CanTpConf_CanTpTxNPdu_CanTpTxNPdu_74904915     0u 
...
#define CANTP_SIZEOFTXQUEUE                                                                         STD_ON
...
#define CANTP_SIZEOFTXQUEUEOFPCCONFIG                                                               STD_ON
...
#define CANTP_TXQUEUEOFPCCONFIG                                                                     STD_ON
...
#define CANTP_ISDEF_TXQUEUEOFPCCONFIG                                                               STD_ON
...
#define CANTP_EQ2_LOLAYERTXPDUIDOFTXSDUCFG                                                          CanIfConf_CanIfTxPduCfg_EIDC_Phy_Resp_Tp_oC03_for_EL_CAN_V2_1_a1fe608c_Tx
#define CANTP_EQ2_NASOFTXSDUCFG                                                                     6u
#define CANTP_EQ2_NBSOFTXSDUCFG                                                                     16u
#define CANTP_EQ2_NCSOFTXSDUCFG                                                                     10u
#define CANTP_EQ2_PDURTXSDUIDOFTXSDUCFG                                                             PduRConf_PduRDestPdu_EIDC_Phy_Resp_oC03_for_EL_CAN_V2_1_0b15e5b1_Tx
#define CANTP_EQ2_RXFCADDRESSOFTXSDUCFG                                                             255u
#define CANTP_EQ2_RXFCPDUIDOFTXSDUCFG                                                               CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_74904915
...
#define CANTP_EQ2_TXPDUCONFIRMATIONPDUIDOFTXSDUCFG                                                  CanTpConf_CanTpTxNPdu_CanTpTxNPdu_74904915
...
#define CANTP_EQ2_TXQUEUEOFPCCONFIG                                                                 CanTp_TxQueue
...
#define CanTp_GetSizeOfTxQueueOfPCConfig()                                                          1u  /**< the number of accomplishable value elements in CanTp_TxQueue */
...
#define CanTp_GetTxQueueOfPCConfig()                                                                CanTp_TxQueue  /**< the pointer to CanTp_TxQueue */
...
#define CanTp_GetTxQueue(Index)                                                                     (CanTp_GetTxQueueOfPCConfig()[(Index)])
...
#define CanTp_GetSizeOfTxQueue()                                                                    CanTp_GetSizeOfTxQueueOfPCConfig()
...
#define CanTp_GetLoLayerTxPduIdOfTxSduCfg(Index)                                                    CanIfConf_CanIfTxPduCfg_EIDC_Phy_Resp_Tp_oC03_for_EL_CAN_V2_1_a1fe608c_Tx
#define CanTp_GetNAsOfTxSduCfg(Index)                                                               6u
#define CanTp_GetNBsOfTxSduCfg(Index)                                                               16u
#define CanTp_GetNCsOfTxSduCfg(Index)                                                               10u
#define CanTp_GetPduRTxSduIdOfTxSduCfg(Index)                                                       PduRConf_PduRDestPdu_EIDC_Phy_Resp_oC03_for_EL_CAN_V2_1_0b15e5b1_Tx
#define CanTp_GetRxFcAddressOfTxSduCfg(Index)                                                       255u
#define CanTp_GetRxFcPduIdOfTxSduCfg(Index)                                                         CanTpConf_CanTpRxFcNPdu_CanTpRxFcNPdu_74904915
...
#define CanTp_GetTxPduConfirmationPduIdOfTxSduCfg(Index)                                            CanTpConf_CanTpTxNPdu_CanTpTxNPdu_74904915
...
#define CanTp_SetTxQueue(Index, Value)                                                              CanTp_GetTxQueueOfPCConfig()[(Index)] = (Value)
...
#define CanTp_HasSizeOfTxQueue()                                                                    (TRUE != FALSE)
...
#define CanTp_HasTxQueue()                                                                          (TRUE != FALSE)
...
#define CanTp_HasSizeOfTxQueueOfPCConfig()                                                          (TRUE != FALSE)
...
#define CanTp_HasTxQueueOfPCConfig()                                                                (TRUE != FALSE)
...
#define CanTp_IncTxQueue(Index)                                                                     CanTp_GetTxQueue(Index)++
...
#define CanTp_DecTxQueue(Index)                                                                     CanTp_GetTxQueue(Index)--
