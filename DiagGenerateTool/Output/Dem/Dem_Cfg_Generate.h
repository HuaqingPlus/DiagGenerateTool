...
#define DEM_TABLE_DEBOUNCE \
	...
	{ /* 0 */0, 0, 100, 100, 0, 0, 0, 0, DEM_CFG_DEBOUNCETYPE_TIMER, 1, 0, DEM_DEBOUNCE_RESET},\
	{ /* 1 */127, -128, 0, 0, -1, 1, 0, 0, DEM_CFG_DEBOUNCETYPE_COUNTER, 0, 1, DEM_DEBOUNCE_RESET},\
...
//DTC Value
#define Dem_Cfg_Num_Of_Event		((uint8)5)
#define Dem_Cfg_Num_Of_DTC			(Dem_Cfg_Num_Of_Event)

#define Dem_Cfg_Mem_Total_Primary_Entry (Dem_Cfg_Num_Of_DTC)
#define Dem_Cfg_Mem_Primary_Entry_Stop  (Dem_Cfg_Mem_Total_Primary_Entry)
#define Dem_Cfg_Mem_Total_Entry      	(Dem_Cfg_Mem_Total_Primary_Entry)
...
#define INDEX_DTC_EVENT_C14099		(0x4)
...
#define DEM_TABLE_EVENT_PARAMETERS \
	...
	{ /* 3 */((void *) 0), 3, DEM_EVENT_KIND_SWC, 255, 1, 3, 3, 0, 0, TRUE},\
	{ /* 4 */((void *) 0), 4, DEM_EVENT_KIND_BSW, 255, 1, 3, 4, 0, 0, TRUE},\
